...
from model_qwen import Transformer
...
def _load_model(checkpoint_path, device, precision, use_tp):
    ...
    model = model.to(device=device) # precision=precison
    return model.eval()
...
def main(
    ...
    checkpoint_path: Path = Path("/home/dongqi/Workspace/gpt-fast/Qwen-1_8B-Chat/model.pth"),
    compile: bool = True,
    ...
    tokenizer = AutoTokenizer.from_pretrained(
        tokenizer_path, trust_remote_code=True, resume_download=True,
    )
    encoded = tokenizer.encode(prompt, device=device, return_tensors="pt").to(device)
